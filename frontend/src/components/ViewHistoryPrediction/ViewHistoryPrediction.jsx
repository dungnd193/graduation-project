            ...
            >
                <div className={classes.resultModal}>
                    ...
                    <div className={classes.modalImg} style={{ overflow: 'hidden', border: '1px solid #c4c4c4' }}>
                        ...
                        <img
                            src={`${process.env.REACT_APP_BASE_API_URL || "http://localhost"}:8000\/images\/input_images\/` + handlePath(view_hist.input_img_path)}
                            alt="input"
                            style={{
                        ...
                        {view_hist.output_img_path && <img
                            ref={maskRef}
                            src={`${process.env.REACT_APP_BASE_API_URL || "http://localhost"}:8000\/images\/masks\/` + handlePath(view_hist.output_img_path)}
                            alt="mask"
                            style={{
                                cursor: 'move',
                                opacity: opacity,
